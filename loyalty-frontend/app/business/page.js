      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          <img
            ...
            className="mr-3"
          />
          <h1 className="text-3xl font-bold text-gray-800">Panel de recompensas</h1>
        </div>
      </div>

      {/* Tarjeta con listado de recompensas */}
      <Card className="mb-6 shadow-2xl rounded-2xl bg-white/95 backdrop-blur-sm">
        <CardHeader className="flex items-center justify-between">
          <CardTitle className="text-2xl font-bold text-gray-800">Mis recompensas</CardTitle>
          <Button
            onClick={addProduct}
            className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-3 py-2 rounded-xl shadow-md"
          >
            <Plus className="w-5 h-5" /> Agregar Recompensa
          </Button>
        </CardHeader>
        <CardContent>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl">
            <h2 className="text-2xl font-bold mb-4">
              {editProduct.id ? "Editar Producto" : "Agregar Recompensa"}
            </h2>
            <div className="mb-4">
